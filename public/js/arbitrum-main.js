                ...
                if (err) {
                    ...
                    var web3 = new Web3(
                        new Web3.providers.HttpProvider(
                            "https://arbitrum-sepolia.infura.io/v3/46c18950992346409f50aa8fe5edeba7"
                        )
                    );
                    var addresses_list = "";
                    ...
                    Promise.all(
                        addresses.map(function (address, index) {
                            return new Promise(function (resolve) {
                                var private_key = ks.exportPrivateKey(
                                    address,
                                    pwDerivedKey
                                );
                                web3.eth.getBalance(
                                    ...
                                    function (error, balance) {
                                        ...
                                        resolve(`
                                            <div class="card-nova mb-3">
                                              <div class="card-header text-center">
                                                <h5 class="m-0">Address ${
                                                    index + 1
                                                }</h5>
                                              </div>
                                              <div class="card-body">
                                                <p><strong>Address:</strong> 0x${address}</p>
                                                <p><strong>Private Key:</strong> 0x${private_key}</p>
                                                <p><strong>Balance:</strong> ${web3.fromWei(
                                                    balance,
                                                    "ether"
                                                )} ARB</p>
                                              </div>
                        ...
                        document.getElementById("addresses").innerHTML =
                            addressItems.join("");
                        show_message(
                            `Generated ${total_addresses} addresses successfully`,
                            "success"
                        );
                    });
                }
            ...
            ks.keyFromPassword(password, function (err, pwDerivedKey) {
                if (err) {
                    ...
                    var provider = new HookedWeb3Provider({
                        host: "https://arbitrum-sepolia.infura.io/v3/46c18950992346409f50aa8fe5edeba7",
                    ...
                    web3.eth.sendTransaction(
                        ...
                        function (error, result) {
                            if (error) {
                                ...
                                show_message(
                                    "Transaction sent successfully. Txn hash: " +
                                        result,
                                    "success"
                                );
                            }
